...
//                    Custom Text field...
                    ...
                    CustomTextField(icon: "envelope", title: "Email", hint: "justine@gmial.com", value: $loginData.email, showPassword: .constant(false))
                        .padding(.top,30)
                    
                    CustomTextField(icon: "lock", title: "Password", hint: "123456", value: $loginData.password, showPassword: $loginData.showPassowrd)
                        .padding(.top,10)
